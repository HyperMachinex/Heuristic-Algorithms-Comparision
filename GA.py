...
#TO DO
# add indmutrate as parameter 
# how much percent of chromosomes will be get mutation
def mutation(offspring, individualLength, lb, ub, mutratepercent = 20):
    """
    ...
    mutationit = int(individualLength * (mutratepercent / 100))
    #print(individualLength)
    #print(mutationit)
    for i in range(mutationit):
